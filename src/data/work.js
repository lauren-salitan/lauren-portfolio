export const workTimeline = [
  ...
  {
    id: "nyc-accelerator",
    company: "NYC Mayor’s Office of Climate (NYC Accelerator)",
    role: "Program Coordinator",
    period: "2021 – 2023",
    highlight: false,
    bullets: [
      "Created internal tools, interactive manuals, and tracking systems for solar feasibility and outreach campaigns.",
      "Streamlined onboarding and workforce development processes; managed web architecture planning."
    ],
  },
];
